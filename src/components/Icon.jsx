...
export default function Icon({ name, size = 16, strokeWidth = 1.75, style }) {
  const paths = {
    ...
    // ── veículos e estados (substitui emojis residuais) ─────────────────────
    car:   <><path d="M5 17H3a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h13l4 4v4a2 2 0 0 1-2 2h-2"/><circle cx="7.5" cy="17" r="1.5"/><circle cx="16.5" cy="17" r="1.5"/><path d="M7 9l1.5-4h7L17 9"/></>,
